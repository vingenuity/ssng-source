class SSG_Cutscene_Closing extends GfxMoviePlayer;

var class<SSG_Message_Cutscene_Closing> MessageClass;
...
DefaultProperties
{
	MovieInfo=SwfMovie'SSG_Closing_Cutscene.SSG_Closing_Cutscene'
	TimingMode=TM_Real
	Priority=10
	...
	MessageClass=class'SSG_Message_Cutscene_Closing'
